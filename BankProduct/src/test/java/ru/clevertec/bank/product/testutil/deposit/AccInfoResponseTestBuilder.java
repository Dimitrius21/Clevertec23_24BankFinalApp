...
@AllArgsConstructor
@NoArgsConstructor(staticName = "aAccInfoResponse")
@With
public class AccInfoResponseTestBuilder implements TestBuilder<AccInfoResponse> {
    ...
    @Override
    public AccInfoResponse build() {
        return new AccInfoResponse(accIban, accOpenDate, currAmount, currAmountCurrency);
    }
